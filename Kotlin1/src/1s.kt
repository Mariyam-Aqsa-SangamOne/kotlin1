...
fun main() {
    ...
    val cities = listOf("San Francisco", "New York", "London", "Dubai", "Bangalore", "Singapore", "Tokyo", "Sydney", "Wellington")
    val offsets = listOf(-7.0, -4.0, 1.0, 4.0, 5.5, 8.0, 9.0, 10.0, 12.0)
